#!/usr/bin/env python3
"""Inspect the local LiteratureReader environment and report setup readiness."""
...
def main() -> None:
    ...
    payload = {
        ...
        "workspace_fallback": {
            ...
            "workspace_output_dir": str(config.get("workspace_output_dir", "LiteratureReader_output")),
            "note": "If no Obsidian vault is configured, LiteratureReader can still save notes under the current working directory.",
        },
        "zotero": {
        ...
        "metadata": {
            "semantic_scholar_api_key_configured": bool(
                env_config_value("LITERATURE_READER_SEMANTIC_SCHOLAR_API_KEY", "SEMANTIC_SCHOLAR_API_KEY")
            )
        },
    }
