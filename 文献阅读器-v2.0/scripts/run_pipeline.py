#!/usr/bin/env python3
"""Run the literature reader pipeline stages sequentially for one paper."""
...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--workdir", default="tmp/LiteratureReader_runs", help="Directory for intermediate artifacts.")
